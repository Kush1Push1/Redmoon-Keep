// Связанное искать по looc_addition
...
/client/verb/looc_1_tile(msg as text)
	set name = "LOOC (1 tile away)"
	set desc = "Local OOC, seen only by everyone on 1 tile near you."
	set category = "OOC"
...
/client/proc/do_looc(msg as text, wp, looc_range = 7)
	...
	for(var/mob/M in range(looc_range,src))
