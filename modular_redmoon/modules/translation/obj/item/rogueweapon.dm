/obj/item/rogueweapon/stoneaxe
	name_gen = "каменного топора" // Родительный падеж
	name_accu = "каменный топор" // Винительный падеж
	name_dat = "каменному топору" // Дательный падеж
	name_inst = "каменным топором" // Творительный падеж
	name_prep = "каменном топоре" // Предложный падеж
